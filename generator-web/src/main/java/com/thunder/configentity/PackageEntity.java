...
public class PackageEntity {
	...
	public PackageConfig getPageConfig(PackageInfo packageInfo) {
		String parentName = StringUtils.isNotBlank(this.getParentName()) ? this.getParentName() : "com.thunder";
		...
		if (StringUtils.isNotBlank(packageInfo.getServiceImplUrl())) {
			map.put(OutputFile.serviceImpl, joinPath(getImplUrl(parentName, serviceName), packageInfo.getServiceImplUrl()));
		}
	 ...
	 * @return
	 */
	private String getImplUrl(String parentName, String serviceName) {
